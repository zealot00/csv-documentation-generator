...
本文档定义 {SYSTEM_NAME} 系统的功能规格，详细描述系统应实现的功能和行为，作为开发、测试和验收的依据。
...
### 3.2 模块说明 / Module Description

| 模块 / Module | 描述 / Description | 依赖模块 / Dependencies |
|-------------|-------------------|----------------------|
| | | |
...
#### 4.1.2 业务流程 / Business Process

| 步骤 / Step | 动作 / Action | 执行者 / Actor | 结果 / Result |
|------------|--------------|---------------|--------------|
| 1 | | | |
| 2 | | | |
...
| 实体 / Entity | 属性 / Attributes | 描述 / Description |
|--------------|------------------|-------------------|
| | | |
...
| 错误代码 / Error Code | 错误描述 / Error Description | 处理方式 / Handling |
|----------------------|---------------------------|-------------------|
| | | |
